# -*- coding: utf-8 -*-
"""
Created on Wed Dec 17 11:43:14 2025
...
ntr = 300 
range_tr = int(yo.size * 0.5)

idx_tr = np.random.choice(range_tr,ntr, replace = False) 
xtr = (x[idx_tr]) 
ytr = (y[idx_tr]) 
...
model.covar_module.base_kernel.period_length = 1 / f

model.covar_module.base_kernel.period_length.requires_grad_=False
